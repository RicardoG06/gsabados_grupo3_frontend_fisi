...
class TrabajadoresAdapterPaseo(val context: Activity, val trabajadores: ArrayList<Trabajadores>) : RecyclerView.Adapter<TrabajadoresAdapterPaseo.TrabajadoresViewHolder>() {
    ...
    private fun goToDetail(trabajador: Trabajadores){
        ...
        val i = Intent(context, PaseadorEscogido::class.java)
