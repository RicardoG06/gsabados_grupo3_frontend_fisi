...
class TrabajadoresAdapter(val context: Activity, val trabajadores: ArrayList<Trabajadores>) : RecyclerView.Adapter<TrabajadoresAdapter.TrabajadoresViewHolder>() {
    ...
    private fun goToDetail(trabajador: Trabajadores){
        ...
        val i = Intent(context, CuidadorEscogido::class.java)
