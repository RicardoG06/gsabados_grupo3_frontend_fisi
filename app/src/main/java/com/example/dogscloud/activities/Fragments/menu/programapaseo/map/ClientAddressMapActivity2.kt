package com.example.dogscloud.activities.Fragments.menu.programapaseo.map
...
class ClientAddressMapActivity2 : AppCompatActivity(), OnMapReadyCallback {
    ...
    private fun onCameraMove(){
        googleMap?.setOnCameraIdleListener {
            ...
            try {
                ...
                city = addressList[0].locality //Obtener cuidad donde estamos
